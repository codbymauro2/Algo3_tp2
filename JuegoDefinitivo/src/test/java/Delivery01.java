...
public class Delivery01 {
    ...
    public void Case01RookieVisitsBankInMontreal() throws IOException {
        ...
        assertTrue(suspect.isGender("Female"));
        assertEquals(stolenItem.getName(),"Tesoro Nacional Montreal");
        assertEquals(detective.enter(bank),"No paso por Aca");
    }
    ...
    public void Case02DetectiveVisitsBankAndLibraryInMontreal() throws IOException {
        ...
        assertEquals(detective.getCurrentCity(),montreal);
        assertEquals(detective.enter(bank),"Pista Banco Media");
        assertEquals(detective.enter(library),"Pista Libreria Media");
    }
    ...
    public void Case03DetectiveTravelsFromMontrealToMexico() throws IOException {
        ...
        assertNotEquals(detective.getCurrentCity(),mexico);
        detective.travel(mexico);
        assertEquals(detective.getCurrentCity(),mexico);
    }
    ...
    public void Case05DetectiveIsStabbedAndSleeps() {
        ...
        assertEquals(detective.getTimeLeftInHours(),152);
        detective.beAttacked(knife);
        assertEquals(detective.getTimeLeftInHours(),150);
        detective.sleep();
        assertEquals(detective.getTimeLeftInHours(),142);
    }
